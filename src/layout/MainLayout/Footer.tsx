...
const Footer = () => {
  ...
  return (
    <Stack
      direction="column"
      sx={{
        p: `${matchDownSM ? '22px 22px 10px 22px' : '48px 48px 10px 48px'}`,
        mt: 'auto',
    ...
    >
          ...
          <Box key={index}>
            <Typography
              ...
              sx={{
                ...
                fontWeight: 500,
                lineHeight: '150%',
                marginBottom: `${matchDownSM ? '30px' : '56px'}`,
                color: 'white'
              }}
            >
              {column.heading}
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap="30px">
